...
Right now this is intended for use with NPGS, and urpec automatically outputs a .dc2 file suitable for NPGS.
...
See the script run_urpec for examples on how to run urpec and how to make run files.
